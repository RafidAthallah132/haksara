...
@section('content')
    <div>
        <a href="/questions_options"><img src="img/kembali.png" height="40" width="40" /></a>
    </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('question_id', 'Pertanyaan*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option', 'Detail Jawaban*', ['class' => 'control-label']) !!}
